...
public class ExampleNetworkedEntityView : ColyseusNetworkedEntityView
{
    ...
    {
        this.gameObject.name = "<color=" + '"' + "green" + '"' + '>' + this.gameObject.name + "</color>";
    }
    ...
    virtual protected void UpdateViewFromState()
    {
        ...
        {
            //Get
            /*MyAnimator.SetFloat("Speed_f", (float)state.a1);
            MyAnimator.SetBool("Jump_trig", state.a2);
            MyAnimator.SetInteger("Animation_int", (int)state.a3);
            MyAnimator.SetBool("Death_b", state.a4);*/
        }
        catch { }
    ...
    protected virtual void UpdateStateFromView()
    {
        ...
        Animator myAnimator = this.GetComponent<Animator>();
        //Set
        /* state.a1 = myAnimator.GetFloat("Speed_f");
         state.a2 = myAnimator.GetBool("Jump_trig");
         state.a3 = myAnimator.GetInteger("Animation_int");
         state.a4 = myAnimator.GetBool("Death_b");*/
    ...
    protected virtual void ProcessViewSync()
    {
        ...
        else
        {
            ...
            {
                if (syncLocalPosition) myTransform.localPosition = latest.pos * extrapolationLength;
