...
public class ExampleManager : ColyseusManager<ExampleManager>
{
    ...
    private ColyseusRoomAvailable[] rooms;
    /// <summary>
    ...
    {
        rooms = await client.GetAvailableRooms(_roomController.roomName);

        onRoomsReceived?.Invoke(rooms);
    }

    /// <summary>
    ///     Return true if room ID available
    /// </summary>
    ...
    {
        return _roomController.LastRoomID;
    }
    ...
    ///<summary>
    ///     Return <see cref="NumberEntityView"/>number of entity view in current room
    /// </summary>
    public int NumberEntityView { get => _roomController.NumberEntityView; }
    ...
    protected override void OnApplicationQuit()
    {
        ...
        System.Threading.Tasks.Task task = _roomController.LeaveAllRooms(true);
